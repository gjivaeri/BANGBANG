...
## 서비스 설명
방탈출 카페 시장규모가 커짐에 따라, 다양하게 즐길 수 있는 반면 불편함이 존재했습니다. 방탈출 카페는 하나의 공식 홈페이지에서 관리하는 것이 아닌, 각 매장별로 홈페이지가 있어 비교를 원할 때에도 일일이 확인을 해야 한다는 번거로움이 있었고, 400여개의 매장과 1737개의 다양한 테마로 정보탐색이 어려워졌으며, 매장 별로 제공된 난이도와 공포도는 개인차가 있어 나에게 꼭 맞는 테마를 찾기 어려웠습니다. 저희는 이러한 어려움을 모든 매장과 테마를 한 사이트에서 모아서 비교하고, 별점/위치/난이도 등 필터 설정하여 쉽게 탐색하여 마지막으로 리뷰를 댓글 형태로 한 눈에 보면서 맞춤화 서비스까지 제공하는 방탈출 리뷰 커뮤니티 서비스를 제안하고자 합니다.
